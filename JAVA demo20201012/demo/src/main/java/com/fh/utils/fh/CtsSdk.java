...
public interface CtsSdk extends Library {
    ...
    public static final int MAX_BROAD_GROUP = 300;    // 最大广播分组数量
    public static final int MAX_BROAD_TERM = 300;   // 每个广播分组的最大终端数量
    ...
    // 终端监听输入音量级别
    public static class enSdkAudCapLevel{
    	public static final int SDK_ACAP_LEVEL_1 = 1; // 2米
    	public static final int SDK_ACAP_LEVEL_2 = 2; // 4米
    	public static final int SDK_ACAP_LEVEL_3 = 3; // 6米
    	public static final int SDK_ACAP_LEVEL_4 = 4;  // 8米
    }

    // 终端功放输出音量级别
    public static class enSdkAudAmpLevel{
    ...
    // 终端对讲输入音量级别
    public static class enSdkAudCapTalkLevel{
    ...
    public class enSdkDevType extends Structure {
    ...
    public static enum enSdkNvrNotifyType{
	    NVR_CHAN_ADD,
		NVR_CHAN_DELETE,
		NVR_CHAN_MODIFY,
    ...
    public class TSdkAudioLevel extends Structure {
        public int eCapLevel;
        public int eAmpLevel; // 输出音量级别：0 ～ 10 (0静音;10最大)
        public int eCapTalkLevel;
    }
    ...
    public class TSdkEventTermRegister extends Structure {
    ...
    public class TSdkEventTermConnect extends Structure {
        public class ByReference extends TSdkEventTermConnect implements Structure.ByReference {}
        public class ByValue extends TSdkEventTermConnect implements Structure.ByValue {}
